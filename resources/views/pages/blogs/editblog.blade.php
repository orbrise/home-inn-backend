...
<section class="page--header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- Page Title Start -->
                            <h2 class="page--title h5">Edit Post</h2>
                            <!-- Page Title End -->
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="panel">
                            ...
                            @if(!empty(session('successmsg')))	<div class="alert alert-success">{{ session('successmsg')}}</div> @endif
                            	<form method="post" action="{{ url('/customers/updatepost')}}" enctype="multipart/form-data">
                            		{{csrf_field()}}
                                ...
                                <div class="form-group">
                                    <label>
                                        ...
                                        <textarea id="mymce" class="form-control" name="long_desc">{{$blog->description}}</textarea>
                                    </label>
                                </div>
                    	...
                    	<div class="panel" style="padding: 15px">
                                    ...
                                    @if(!empty($allparents))
                                        <select  name="cat" class="form-control" required >
                                            ...
                                            <option value="{{ $parent->id }}" @if($parent->id == $blog->category) selected @endif>{{ $parent->name }}</option>
                                            @endforeach
...
<br><img src="{{ url($blog->blogimg)}}" width="100">
